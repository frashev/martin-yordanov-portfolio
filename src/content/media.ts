...
export const gallery: GalleryItem[] = [
  {
    ...
    src: assetPath("martin/kinetic-sand-table-hero.jpg"),
  ...
  },
  {
    ...
    src: assetPath("martin/wall-plotter-toolhead.jpg"),
